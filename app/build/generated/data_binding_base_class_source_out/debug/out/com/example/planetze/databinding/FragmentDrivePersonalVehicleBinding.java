...
public final class FragmentDrivePersonalVehicleBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentDrivePersonalVehicleBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentDrivePersonalVehicleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentDrivePersonalVehicleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_drive_personal_vehicle, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDrivePersonalVehicleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDrivePersonalVehicleBinding((ConstraintLayout) rootView, back, distance,
          option1, option2, option3, option4, submit);
    }
