...
public final class FragmentFlightBinding implements ViewBinding {
  ...
  private FragmentFlightBinding(@NonNull ConstraintLayout rootView, @NonNull Button back,
  ...
  @NonNull
  public static FragmentFlightBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFlightBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_flight, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFlightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFlightBinding((ConstraintLayout) rootView, back, distance, option1,
          option2, submit);
    }
