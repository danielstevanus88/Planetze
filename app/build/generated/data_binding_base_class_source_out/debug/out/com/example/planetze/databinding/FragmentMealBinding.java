...
public final class FragmentMealBinding implements ViewBinding {
  ...
  @NonNull
  public final Button option5;

  @NonNull
  public final Button submit;

  private FragmentMealBinding(@NonNull ConstraintLayout rootView, @NonNull Button back,
      @NonNull EditText distance, @NonNull Button option1, @NonNull Button option2,
      @NonNull Button option3, @NonNull Button option4, @NonNull Button option5,
  ...
  public static FragmentMealBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.option5;
      Button option5 = ViewBindings.findChildViewById(rootView, id);
      if (option5 == null) {
        break missingId;
      }
      ...
      return new FragmentMealBinding((ConstraintLayout) rootView, back, distance, option1, option2,
          option3, option4, option5, submit);
    }
